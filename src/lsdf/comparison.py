    ...
    *,
    ...
    return {
        **base,
        ...
        "evaluation_error_categories": report["evaluation_error_categories"],
        "blocked": report["blocked"],
        "misses": report["misses"],
        "known_gap_misses": report["known_gap_misses"],
        "mutated_cases": report["mutated_cases"],
        "unwanted_mutations": report["unwanted_mutations"],
        "json_text_mutations": report["json_text_mutations"],
        "known_gap_unwanted_mutations": report["known_gap_unwanted_mutations"],
        "unwanted_blocks": report["unwanted_blocks"],
        "known_gap_unwanted_blocks": report["known_gap_unwanted_blocks"],
